...
def get_template_context():
    ...
    return {
        ...
        "auth": {
            ...
            "register_desc": "Créer le premier compte administrateur et son exploitation",
            "refresh_desc": "Tester le endpoint refresh placeholder",
            "form_labels": {
                "producer_id": "ID producteur existant (laisser vide au premier démarrage):",
                "email": "Email:",
                "password": "Mot de passe:",
                "first_name": "Prenom:",
                "last_name": "Nom:",
                "producer_name": "Nom de l'exploitation:",
                "producer_address": "Adresse de l'exploitation:",
                "producer_postal_code": "Code postal:",
                "producer_city": "Ville:",
                "producer_country": "Pays:",
                "role": "Role:",
            ...
            "form_placeholders": {
                ...
                "first_name": "Camille",
                "last_name": "Martin",
                "producer_name": "ex: Ferme des Trois Chênes",
                "producer_address": "ex: 12 chemin des Prés",
                "producer_postal_code": "ex: 47000",
                "producer_city": "ex: Agen",
